...
outconfpath = '/usr/scratch/tretyakov/01_2tlb/prc_nc1000N40dT3.0g1.5dt0.005_16/'#'./local_test/'
...
print '{:22}'.format('LB-coupling friction:', gamma)
...
lb.fricCoeff = gamma  # coupling friction coefficient
